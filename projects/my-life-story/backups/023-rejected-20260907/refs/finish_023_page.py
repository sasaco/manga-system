"""Finish episode 023 using separate Krita artwork, balloon, and text layers."""
...
balloon.save(HERE / "023-balloon.png")
lettering.save(HERE / "023-lettering.png")

preview = Image.new("RGBA", (W, H), "white")
preview = Image.alpha_composite(preview, Image.open(HERE / "023-color.png").convert("RGBA"))
gray = ImageOps.grayscale(Image.open(HERE / "023-control.png"))
...
preview.save(HERE / "023-preview.png")

settings = json.loads((P / "project.json").read_text(encoding="utf-8"))
ora = P / "pages/.023-finished.ora"
prepare_page(
    ROOT / "templates/krita" / settings["page_template"],
    P / "panels/selected/023.png",
    ora,
    line_art=HERE / "023-control.png",
    color_art=HERE / "023-color.png",
)
