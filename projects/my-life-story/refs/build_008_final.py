...
SELECTED_ART = PROJECT_DIR / 'panels' / 'selected' / '008.png'
LINE_ART = PROJECT_DIR / 'refs' / '008-control.png'
COLOR_ART = PROJECT_DIR / 'refs' / '008-color.png'
BALLOON_ART = PROJECT_DIR / 'refs' / '008-balloon.png'
LETTERING_ART = PROJECT_DIR / 'refs' / '008-lettering.png'

KRA_OUTPUT = PROJECT_DIR / 'pages' / '008.kra'
EXPORT_OUTPUT = PROJECT_DIR / 'export' / '008.png'
...
def main():
    ...
    temp_ora = PROJECT_DIR / 'pages' / '.008.final.ora'
    temp_kra = PROJECT_DIR / 'pages' / '.008.final.kra'
