...
SELECTED_ART = PROJECT_DIR / 'panels' / 'selected' / '010.png'
LINE_ART = PROJECT_DIR / 'refs' / '010-control.png'
COLOR_ART = PROJECT_DIR / 'refs' / '010-color.png'
BALLOON_ART = PROJECT_DIR / 'refs' / '010-balloon.png'
LETTERING_ART = PROJECT_DIR / 'refs' / '010-lettering.png'

KRA_OUTPUT = PROJECT_DIR / 'pages' / '010.kra'
EXPORT_OUTPUT = PROJECT_DIR / 'export' / '010.png'
...
def main():
    ...
    temp_ora = PROJECT_DIR / 'pages' / '.010.final.ora'
    temp_kra = PROJECT_DIR / 'pages' / '.010.final.kra'
