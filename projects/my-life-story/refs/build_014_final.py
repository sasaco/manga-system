...
SELECTED_ART = PROJECT_DIR / 'panels' / 'selected' / '014.png'
LINE_ART = PROJECT_DIR / 'refs' / '014-control.png'
COLOR_ART = PROJECT_DIR / 'refs' / '014-color.png'
BALLOON_ART = PROJECT_DIR / 'refs' / '014-balloon.png'
LETTERING_ART = PROJECT_DIR / 'refs' / '014-lettering.png'

KRA_OUTPUT = PROJECT_DIR / 'pages' / '014.kra'
EXPORT_OUTPUT = PROJECT_DIR / 'export' / '014.png'
...
def main():
    ...
    temp_ora = PROJECT_DIR / 'pages' / '.014.final.ora'
    temp_kra = PROJECT_DIR / 'pages' / '.014.final.kra'
