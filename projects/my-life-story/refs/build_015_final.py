...
SELECTED_ART = PROJECT_DIR / 'panels' / 'selected' / '015.png'
LINE_ART = PROJECT_DIR / 'refs' / '015-control.png'
COLOR_ART = PROJECT_DIR / 'refs' / '015-color.png'
BALLOON_ART = PROJECT_DIR / 'refs' / '015-balloon.png'
LETTERING_ART = PROJECT_DIR / 'refs' / '015-lettering.png'

KRA_OUTPUT = PROJECT_DIR / 'pages' / '015.kra'
EXPORT_OUTPUT = PROJECT_DIR / 'export' / '015.png'
...
def main():
    ...
    temp_ora = PROJECT_DIR / 'pages' / '.015.final.ora'
    temp_kra = PROJECT_DIR / 'pages' / '.015.final.kra'
