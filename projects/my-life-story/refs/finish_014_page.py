...
# ── Balloon: slightly higher and broader at upper middle ──
bubble = oval_points((120, 50, 640, 270), phase=0.8)
...
vertical_text('「腕一本で成り上がる」…', 480, 95, spacing=33, font=bold_font)
vertical_text('勘違いヤローでした', 280, 100, spacing=35, font=reg_font)

here = Path('projects/my-life-story/refs')
balloon_layer.resize((WIDTH, HEIGHT), Image.Resampling.LANCZOS).save(here / '014-balloon.png')
lettering_layer.resize((WIDTH, HEIGHT), Image.Resampling.LANCZOS).save(here / '014-lettering.png')

line_img = Image.open(here / '014-control.png').convert('RGBA')
color_img = Image.open(here / '014-color.png').convert('RGBA')
...
preview.save(here / '014-preview.png')
print('Updated 014-preview.png')
