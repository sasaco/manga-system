...
SELECTED_ART = PROJECT_DIR / 'panels' / 'selected' / '011.png'
LINE_ART = PROJECT_DIR / 'refs' / '011-control.png'
COLOR_ART = PROJECT_DIR / 'refs' / '011-color.png'
BALLOON_ART = PROJECT_DIR / 'refs' / '011-balloon.png'
LETTERING_ART = PROJECT_DIR / 'refs' / '011-lettering.png'

KRA_OUTPUT = PROJECT_DIR / 'pages' / '011.kra'
EXPORT_OUTPUT = PROJECT_DIR / 'export' / '011.png'
...
def main():
    ...
    # Place the Comfy image on AI素材 layer
    layers['AI素材'].set('visibility', 'visible')
    ...
    merged = paper
    merged = Image.alpha_composite(merged, ai_layer)
    ...
    temp_ora = PROJECT_DIR / 'pages' / '.011.final.ora'
    temp_kra = PROJECT_DIR / 'pages' / '.011.final.kra'
