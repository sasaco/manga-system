...
SELECTED_ART = PROJECT_DIR / 'panels' / 'selected' / '012.png'
LINE_ART = PROJECT_DIR / 'refs' / '012-control.png'
COLOR_ART = PROJECT_DIR / 'refs' / '012-color.png'
BALLOON_ART = PROJECT_DIR / 'refs' / '012-balloon.png'
LETTERING_ART = PROJECT_DIR / 'refs' / '012-lettering.png'

KRA_OUTPUT = PROJECT_DIR / 'pages' / '012.kra'
EXPORT_OUTPUT = PROJECT_DIR / 'export' / '012.png'
...
def main():
    ...
    temp_ora = PROJECT_DIR / 'pages' / '.012.final.ora'
    temp_kra = PROJECT_DIR / 'pages' / '.012.final.kra'
