...
SELECTED_ART = PROJECT_DIR / 'panels' / 'selected' / '013.png'
LINE_ART = PROJECT_DIR / 'refs' / '013-control.png'
COLOR_ART = PROJECT_DIR / 'refs' / '013-color.png'
BALLOON_ART = PROJECT_DIR / 'refs' / '013-balloon.png'
LETTERING_ART = PROJECT_DIR / 'refs' / '013-lettering.png'

KRA_OUTPUT = PROJECT_DIR / 'pages' / '013.kra'
EXPORT_OUTPUT = PROJECT_DIR / 'export' / '013.png'
...
def main():
    ...
    temp_ora = PROJECT_DIR / 'pages' / '.013.final.ora'
    temp_kra = PROJECT_DIR / 'pages' / '.013.final.kra'
