...
- Do not use external image generation for project assets. Use Comfy, finish in Krita, and require `.\manga.ps1 validate -Project my-life-story` to pass before completion.
